...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.posts.posts', compact('posts', 'auth_user', 'user'));
    }
    ...
    public function store(PostRequest $request)
    {
        ...
        return redirect()->route('homepage')->withFragment('#blog-published');
    }
    ...
    public function show($slug)
    {
        ...
        return view('dashboard.posts.posts', compact('post', 'posts', 'auth_user', 'user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.posts.posts_edit', compact('post'));
    }
